...
for i in xrange(1,len(objects)):
    ...
    cnt = contours2[int(objects[i][1])]
    ellipse = cv2.fitEllipse(cnt)
    cv2.ellipse(lefthand,ellipse,(255,0,0),2)
    print('distance between center and {} is {}'.format(i, dist))
    print('the center is ({},{}) and the ellipse center({},{}), height/width({},{}), angle {}'.format(int(objects[i][2]), int(objects[i][3]), ellipse[0][0], ellipse[0][1], ellipse[1][0], ellipse[1][1], ellipse[2]))
