...
small1 = first_hand.rotateImage(small1, first_hand.get_normalization_box_angle()+270)
...
small2 = second_hand.rotateImage(small2, second_hand.get_normalization_box_angle())
